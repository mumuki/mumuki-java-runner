...
/*#Destinatario.java>*/
    ...
    it 'with passing test and expectations' do
      ...
      expect(response).to eq(response_type: :structured,
                             test_results: [{ title: 'email admite elaborar', status: :passed, result: nil }],
                             status: :passed,
                             feedback: '',
                             expectation_results: [
...
public void email_admite_elaborar() {
  ...
  Assert.assertEquals("Para: Juano Gomez <juanogomez@gmail.com>\\nHola juano!!", email.elaborar());
      ...
      it {
        ...
        expect(response).to eq(response_type: :structured,
                               test_results: [{ title: 'email admite elaborar', status: :failed, result: format("expected:<Para: Juan[o Gomez <juanogomez@gmail.com>\nHola juano]!!> but was:<Para: Juan[ Perez <juanperez@gmail.com>\nHola juan]!!>")}],
                               status: :failed,
                               feedback: '',
                               expectation_results: [
